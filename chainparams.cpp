...
public:
	...
	const char* pszTimestamp = "How Blockchain Technology Can Save The IRS";
        //const char* pszTimestamp = "UK hospital launches rehab programme for bitcoin addiction";
        ...
        vout[0].SetEmpty();
        CTransaction txNew(1, 1528221347, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1528221347;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 857701;
        hashGenesisBlock = genesis.GetHash();
//	printf("%s\n", hashGenesisBlock.ToString().c_str());
//	printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
	assert(hashGenesisBlock == uint256("ca7a39b78e57f570127d121c941158d12740a5847d1789749bea662e286cb018"));
	assert(genesis.hashMerkleRoot == uint256("0x1215efd749552ec59bef149d7e1268d6187b4a8628876b8900d456c6580d98dd"));
...
public:
    CTestNetParams() {
        ...
        genesis.nTime    = 1528219253;
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 0;

        hashGenesisBlock = genesis.GetHash();
//	assert(hashGenesisBlock == uint256("af0f77605027a2c2c25a7c3c75e018da4e9aa38ee95087fd0e3e230bc38f4958"));
