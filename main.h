...
static const int64_t MAX_SINGLE_TX = 128000000 * COIN; // 5 Million IzeC coins
/** Moneyrange params */
...
/** PoS Reward */
static const int64_t COIN_YEAR_REWARD = 15 * CENT;//1.5 * COIN; // Corrected in v1.0.2.0+
/** PoS Reward Fixed */
static const int64_t COIN_YEAR_REWARD_FIXED = 5 * CENT;//50 * CENT; // 50%     0.5 * COIN
/** PoS Superblock Reward */
static const int64_t COIN_SPRB_REWARD = 30 * CENT;//3 * COIN; // Corrected in v1.0.2.0+
/** PoS Superblock Reward Fixed */
static const int64_t COIN_SPRB_REWARD_FIXED = 5.5 * CENT; //55 * CENT; // 55%     0.55 * COIN
/** PoS Reward Correct */
...
/** PoS Interest **/
static const int64_t COIN_YEAR_INTEREST = 5 * CENT; //50 * CENT; // 50%         0.5 * COIN
/** MN Reward Fixed */
static const int64_t MN_REWARD_FIXED = 5 * CENT; //50 * CENT;    //             0.5 * COIN
...
inline int64_t MasternodeCollateral(int nHeight) { return 2000; } // 5K IZE required as collateral
...
static const int64_t nBlockRewardReserve = 3657142.85 * COIN; //1369192.5
...
static const int64_t nReservePhaseEnd = 15;
...
bool AcceptToMemoryPool(CTxMemPool& pool, CTransaction &tx, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectIzeCFee=false, bool ignoreFees=false);

bool AcceptableInputs(CTxMemPool& pool, const CTransaction &txo, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectIzeCFee=false, bool isDSTX=false);
...
public:
    ...
    bool AcceptToMemoryPool(bool fLimitFree=true, bool fRejectIzeCFee=true, bool ignoreFees=false);
